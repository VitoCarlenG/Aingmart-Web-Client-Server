<?php
    if(isset($_POST['update'])){
        ...
        if(empty($_POST["nama"]) && empty($_POST["password"])) {
            ...
            <script>
            window.location = '../page/updateProfilPenggunaPage.php?id=$id'
            </script>";
        ...
        if($query){
            echo
                '<script>alert("Edit Profil Pengguna Berhasil"); window.location = "../page/readPage.php"</script>';
        }else{
            echo
                '<script>alert("Edit Profil Pengguna Gagal");</script>';
        }
        }
